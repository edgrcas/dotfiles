...
alias hotfix='git add . && git commit -am "hotfix" && git push origin dev && gco master && git merge dev && git push origin master'
...
alias gfd='git checkout dev && git add . & git commit -am "chore(core): fix" && git push origin dev && git checkout master && git merge dev && git push origin master'
